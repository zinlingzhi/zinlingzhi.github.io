...
const Projects = () => {
  ...
  const revealArchiveLink = useRef<HTMLLinkElement>(null);
  const revealProjects = useRef<(HTMLElement | null)[]>([]);
  ...
  const GRID_LIMIT = 6;
  const projects: Project[] = data.projects.edges;
  const firstSix: Project[] = projects.slice(0, GRID_LIMIT);
